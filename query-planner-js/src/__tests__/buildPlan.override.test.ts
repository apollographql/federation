...
describe('override with label (progressive)', () => {
  ...
  //       type T @key(fields: "i") {
  //         i: ID!
  //         f: Int @override(from: "S1", label: "test")
  //       }
  //     `,
  //   };
  //   const [api, queryPlanner] = composeAndCreatePlanner(s1, s2);
  ...
  //   it.only('TODO', () => {
  //     const overriddenPlan = queryPlanner.buildQueryPlan(operation, { overriddenLabels: new Set(['test']), });
  //     expect(overriddenPlan).toMatchInlineSnapshot();
  //   });
  // });
});
