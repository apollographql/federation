...
By the end of this tutorial, you will have set up a federated GraphQL API using a demo supergraph.
...
- [Publish](/graphos/delivery/publishing-schemas/) your locally running supergraph to GraphOS Studio and share with your team.
