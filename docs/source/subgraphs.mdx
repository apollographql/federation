...
> To be part of a supergraph, a subgraph must conform to the [Apollo Federation subgraph specification](./federation-spec/), which exposes the subgraph's capabilities to your graph router, as well as to tools like Apollo Studio.
