...
* If you currently use a different federated architecture (such as schema stitching), you can [add federation support to your existing implementing services one at a time](/migrating-from-stitching/).
