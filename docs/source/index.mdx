...
In a federated architecture, each subgraph instance is a GraphQL service, and _so is the router_. External clients query the router, and the router then queries individual subgraphs to obtain, combine, and return results:
