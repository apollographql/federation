...
The router intelligently calls all the services it needs to complete a request, rather than simply forward them.
...
With federation, every team contributes directly to the overall federated GraphQL schema. Each team can work independently without needing to maintain multiple API layers. This frees up your platform team to focus on the quality of your API, rather than keeping it up to date.
