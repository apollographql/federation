...
Federation supports a free managed mode with [Apollo GraphOS](/graphos/), which helps you modify and grow your supergraph without any downtime. GraphOS can also provision and host your supergraph's router for you.
