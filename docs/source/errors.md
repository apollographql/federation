...
| `MERGE_DIRECTIVES_BUILT_IN_DIRECTIVE` | No directive specified in the "mergeDirectives" may be a GraphQL builtin directive | 2.0.0 |  |
| `MERGE_DIRECTIVES_DIRECTIVE_DOES_NOT_EXIST` | All directives specified in the "mergeDirectives" argument must exist in at least one subgraph | 2.0.0 |  |
| `MERGE_DIRECTIVES_FEDERATION_NAME_CONFLICT` | No directive specified in the "mergeDirectives" may be used as a federation directive in any subgraph | 2.0.0 |  |
| `MERGE_DIRECTIVES_NO_LEADING_AT` | All directive names specified in the "mergeDirectives" argument must begin with "@" | 2.0.0 |  |
