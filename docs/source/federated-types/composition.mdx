...
* If multiple subgraphs define the same field, that field must have a compatible return type _and_ compatible argument types across each defining subgraph.
    * For examples of compatible and incompatible field return types, see [Varying field return types](./value-types/#varying-field-return-types).
...
> This key field restriction might change in a future update to Federation 2. [See details.](../federation-2/under-consideration/#entity-changes)
