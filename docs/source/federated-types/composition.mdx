...
To learn how to install Rover and use this command, see the [Quickstart](../quickstart/#1-install-the-rover-cli).
...
To learn how to perform composition with managed federation, see the [Quickstart](../quickstart-pt-2/).
