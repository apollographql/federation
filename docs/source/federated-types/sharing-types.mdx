...
See [Input types and field arguments](./composition#input-types-and-field-arguments) to learn more.
...
>  You can also use the `enum` type across multiple subgraphs, see [Merging types from multiple subgraphs](composition#enums) to learn more.
