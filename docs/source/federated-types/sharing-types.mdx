...
See [Merging input types and field arguments](./composition#merging-input-types-and-field-arguments) to learn more.
...
[Compositional logic](./composition#merging-types-during-composition) merges these definitions in your supergraph schema:
...
>  You can also use the `enum` type across multiple subgraphs, see [Merging enums](composition#merging-enums) to learn more.
...
Compositional logic merges only the fields that all `input` types have in common. To learn more, see [Merging input types and field arguments](./composition#merging-input-types-and-field-arguments).
...
To learn more about how composition merges different schema types under the hood, see [Merging types during composition](./composition#merging-types-during-composition)