...
The `@shareable` directive enables you to share all of the fields on a **type**, or selected individual **fields**, across multiple subgraphs. 
...
<!-- TODO: figure out where to introduce that two types with duplicate fields will break composition -->
