...
The `@context` directive defines a named context from which any field of the annotated type can be passed to a getter of the context (a field annotated with [`@fromContext`](#fromcontext)). 
