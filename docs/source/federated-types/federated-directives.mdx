...
Indicates that an object definition serves as an abstraction of another subgraph's _entity interface_. This abstraction enables a subgraph to automatically contribute fields to _all_ entities that implement a particular entity interface.
