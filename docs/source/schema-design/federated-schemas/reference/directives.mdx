...
Enum types are supported in the `format` argument. If you encounter composition errors when using enums, ensure you're using Router v2.8.2 or later, which includes a fix for enum validation.
