...
For details, see [Using `@provides`](/graphos/schema-design/federated-schemas/entities/resolve-another-subgraphs-fields#using-provides) and [Best practices for using the `@provides` directive](/graphos/schema-design/federated-schemas/entities/provides-directive).
