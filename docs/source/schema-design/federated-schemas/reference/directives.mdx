...
For more information, see [Using `@provides`](/graphos/schema-design/federated-schemas/entities/resolve-another-subgraphs-fields#using-provides) and [Best Practices for Using the `@provides` Directive](/graphos/schema-design/federated-schemas/entities/provides-directive).
