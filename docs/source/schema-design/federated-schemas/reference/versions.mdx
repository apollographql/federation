...
Federation doesn't support interfaces as the target of `@interfaceObject`. If your schema uses this pattern, composition now reports `INTERFACE_OBJECT_USAGE_ERROR`.
