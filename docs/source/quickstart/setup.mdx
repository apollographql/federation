...
* Via _managed federation_ in Apollo Studio (we'll start with this)
...
As mentioned in [Federation concepts](#federation-concepts), your federated supergraph is represented by a _graph router_ that routes queries to various subgraphs. For this tutorial, we'll use some Apollo-hosted example services as our subgraphs, and we'll set up the Apollo Router in front of them.
