...
A service that you want to act as a subgraph can use any GraphQL server that supports Apollo Federation. This includes Apollo Server, along with the other servers listed in [Federation-compatible subgraph implementations](../supported-subgraphs/).
