...
subtitle: "Part 3: Local composition"
description: Compose your federated GraphQL schema locally using the Rover CLI. After composing the schema, provide it to your graph router.
---
