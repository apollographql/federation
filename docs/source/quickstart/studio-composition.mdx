...
subtitle: "Part 2: Composition in GraphOS Studio"
description: Compose your federated GraphQL API schema with GraphOS Studio. Register you subgraph schemas and authenticate your graph router.
---
