...
You don't need to understand the details of query plans to get started with Apollo Federation. This information is provided primarily for advanced debugging purposes.
