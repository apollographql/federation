...
If you haven't already, see the [Query Plan overview](/graphos/get-started/concepts/query-plans) article.
...
Read more about how `@defer` works in the [router support for @defer article](/router/executing-operations/defer-support/).
...
- [In the GraphOS Studio Explorer](/graphos/querying-your-graph/explorer/additional-features#query-plans-for-supergraphs)
