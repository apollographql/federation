...
- To use a feature introduced in a particular federation version, make sure your subgraph schema's `@link` directive targets that version (or higher):
    ...
    Before you increment a subgraph's federation version, update your router and build pipeline. For details, see [Updating your graph safely](/graphos/deployment/admin/updates).
...
Introduced. [Learn more.](/graphos/schema-development/federated-schemas/entities/interfaces)
...
Can now be applied to interface definitions to support [entity interfaces](/graphos/schema-development/federated-schemas/entities/interfaces/).
...
The `fields` argument can now include fields that themselves take arguments. [Learn more.](graphos/schema-development/federated-schemas/entities/contribute-fields#using-requires-with-fields-that-take-arguments)
...
* Value type fields can differ across subgraphs (in certain ways). For details, see [Differing shared fields](/graphos/schema-development/federated-schemas/sharing-types#differing-shared-fields).
