...
- Using GraphQL subscriptions with a federated graph requires a compatible version of the Apollo Router Core. [See details.](/router/executing-operations/subscription-support/#prerequisites)
