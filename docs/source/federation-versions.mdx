...
Introduced. [Learn more](./federated-schemas/federated-directives/#cost).
...
Introduced. [Learn more](./federated-schemas/federated-directives/#listsize).
...
The `fields` argument can now include fields that themselves take arguments. [Learn more.](./entities/contribute-fields/#using-requires-with-fields-that-take-arguments)
