...
![Diagram of a basic GraphQL architecture](../images/federation-guide/basic-graphql-server.png)

As different teams begin to adopt GraphQL, their approach will usually be adapted from this basic architecture, but the implementation details may vary from from team to team. At Apollo, we've typically seen that those initial, unconsolidated efforts resemble one of the following four patterns.
...
![Client-only GraphQL pattern](../images/federation-guide/pattern-client-only.png)
...
![Backends for frontends pattern](../images/federation-guide/pattern-bff.png)
...
![Monolithic GraphQL API pattern](../images/federation-guide/pattern-monolith.png)
...
![Multiple overlapping GraphQL APIs pattern](../images/federation-guide/pattern-multiple-graphs.png)

### Where Do These Patterns Break Down?

After taking stock of who uses GraphQL and how in your company, the patterns the various teams have implemented can provide insight into what kinds of problems they initially tried to solve. Similarly, these choices can help highlight what GraphQL pain points the teams currently face in their tech stacks.
...
![A federated GraphQL architecture](../images/federation-guide/federated-architecture.png)
