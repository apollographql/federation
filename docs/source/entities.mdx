...
Some details of entity behavior have changed in Federation 2. For a summary of these changes, [see what's new in Federation 2](./federation-2/new-in-federation-2/).
