...
> ⚠️ **Reference resolvers _will_ be called more than once per query. It is crucial that they account for N+1 issues (e.g., via [data loaders](https://github.com/graphql/dataloader)). See [The N+1 problem](../entities-advanced#the-n1-problem) for more details.**
