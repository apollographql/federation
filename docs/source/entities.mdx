...
Whenever a subgraph extends an entity with a new field, it's also responsible for _resolving_ that field. The gateway is automatically aware of this responsibility. In our example: TODO
