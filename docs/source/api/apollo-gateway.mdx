...
This method must return an object that matches the structure of a [`GraphQLResponse`](https://github.com/apollographql/apollo-server/blob/dd15bc1d7df6b5614b53e5cad62699222dc44279/packages/server/src/externalTypes/graphql.ts#L49).  If no modifications are necessary, return the original `response`.
...
[The `context` argument](/docs/apollo-server/data/resolvers/#the-context-argument) passed between the GraphQL operation's resolvers.
</td>
</tr>
</tbody>
</table>
