...
description: "Part 3 - Working with subraphs"
---
...
> The official docs for schema checks still use `apollo` CLI commands instead of `rover`. Wherever those docs use `apollo service:check`, you can use `rover subgraph check` instead. For details, [see the Rover docs](https://www.apollographql.com/docs/rover/subgraphs/#checking-subgraph-schema-changes).

[Learn all about schema checks](https://www.apollographql.com/docs/studio/schema-checks/), and [how to use Rover in a CI/CD environment](https://www.apollographql.com/docs/rover/ci-cd/).
