...
subtitle: Learn how to move parts of one subgraph to another
...
That's it! The migrated fields have been moved to a new subgraph with only one router redployment.
