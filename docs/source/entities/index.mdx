...
subtitle: Learn how to contribute fields to a federated type from across multiple subgraphs
...
In a supergraph, an _entity_ is an object type that can resolve its fields across multiple subgraphs.
...
You can use entities with many complex use cases, check out these guides to learn more:

- [Define `@keys` for complex use cases]()
- [Define `@keys` for complex use cases]()
- [Define `@keys` for complex use cases]()
