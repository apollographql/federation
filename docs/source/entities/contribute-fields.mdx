...
To override this default behavior, see [Resolving another subgraph's field](/graphos/schema-development/federated-schemas/entities/resolve-another-subgraphs-fields).
