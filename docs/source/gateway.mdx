...
You might need to use Apollo Server for your graph router if your subgraphs use a custom authentication method that it's currently difficult to configure with the Apollo Router, especially for teams unfamiliar with Rust.
