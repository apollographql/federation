...
The [`@apollo/gateway`](https://github.com/apollographql/federation) package extends Apollo Server's functionality, enabling it to act as a gateway for an Apollo Federation architecture.
