...
The `@key` directive supports the `__typename` [meta field](https://graphql.org/learn/queries/#meta-fields) to declare an entity as a [singleton](https://en.wikipedia.org/wiki/Singleton_pattern).
