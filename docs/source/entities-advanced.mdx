...
- If you define your subgraph schema in an SDL file (instead of programmatically), you escape quotes for string and enum values with backslashes (as shown above).
