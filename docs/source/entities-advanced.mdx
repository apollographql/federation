...
A subgraph that [references an entity](./entities/#referencing-an-entity) without contributing any fields of its own can include the fields of any `@key` in its stub definition:
