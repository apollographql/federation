...
* Most importantly, **Federation 2 is backward compatible with most Federation 1 graphs.** You can probably move your existing graph to Federation 2 without needing to make any changes.
    ...
    * To take full advantage of Federation 2 features, you do need to make some changes to your subgraph schemas, but you can make these changes at your convenience. See [Moving to Apollo Federation 2](./moving-to-federation-2/).
