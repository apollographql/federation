...
In Federation 2, shared enums and unions can have _completely different_ definitions between subgraphs. For details, see [Enums and unions](../federated-types/types-fields/#enums-and-unions).
