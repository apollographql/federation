...
In Federation 1, multiple subgraphs can define the same type, but those definitions must all be _identical_. These identical shared types are called _value types_:
