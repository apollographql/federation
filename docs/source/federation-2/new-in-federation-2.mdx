...
> In some cases, you still might want to enforce the schema requirements defined in Federation 1. The full release of Federation 2 will include support for directives that enable this. For details, see [Federated ownership directives](../federated-types/ownership-directives/).
...
There are many more features currently under consideration for the full release of Federation 2. [See what's under consideration.](./under-consideration/)
