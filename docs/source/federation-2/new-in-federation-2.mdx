...
In Federation 2, shared enum and union definitions can differ between subgraphs. For details, see [Enums and unions](../federated-types/sharing-types/#enums-and-unions).
