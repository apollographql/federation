...
**Probably not.** Federation 2 [relaxes composition rules](./new-in-federation-2/#relaxed-composition-rules) from Federation 1. If you modify your subgraph schemas to take advantage of these relaxed rules, your graph will no longer compose with Federation 1. You need to revert these changes to move _back_ to Federation 1.
