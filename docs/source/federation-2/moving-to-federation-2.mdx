...
By default in Federation 2, most schema fields are resolvable by only a _single subgraph_. In Federation 1, this is _not_ true for [value types](https://www.apollographql.com/docs/federation/sharing-types/):
...
In Federation 2, the term "value type" is no longer used. For details, see [Sharing types](../federated-types/sharing-types/).
