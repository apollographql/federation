...
* Your routers can poll GraphOS&mdash;specifically, its [Apollo Uplink](/graphos/routing/uplink) endpoint&mdash;to get the latest validated supergraph schema and other configurations.
