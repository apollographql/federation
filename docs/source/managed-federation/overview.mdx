...
## Manual Composition
Using Managed Federation should be the default for all production systems, but in some use cases, like local developement, it can be helpful to [manualy compose the supergraph yourself](https://www.apollographql.com/docs/technotes/TN0006-unmanaged-federation/).
