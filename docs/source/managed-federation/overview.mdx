...
[Apollo Studio](https://www.apollographql.com/docs/studio/federated-graphs/) provides free **managed federation** features for data graphs that use Apollo Federation.
