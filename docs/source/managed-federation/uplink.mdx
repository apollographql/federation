...
For an example with operations calling the Platform API, see a [blue-green deployment example](/graphos/deployment/production-readiness/best-practices#example-blue-green-deployment).
