---
title: "Implementing services (subgraphs)"
---
...
This article describes how to create an **implementing service** (also known as a **subgraph**) for a federated data graph using Apollo Server.

## Defining an implementing service

> To be part of a federated graph, an implementing service must conform to the [Apollo Federation specification](/federation-spec/), which exposes the service's capabilities to the gateway, as well as to tools like Apollo Studio.
