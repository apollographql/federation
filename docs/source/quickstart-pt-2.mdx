...
Nice work! We've got two **subgraphs** registering their schemas with Apollo, and we've got a **federated gateway** that then fetches the composed **supergraph schema**.
...
There are many more powerful features in Apollo Federation and Apollo Studio that we have yet to cover. For those, [let's head to part 3!](./quickstart-pt-3/)
