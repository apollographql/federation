...
| `--variant` | <p>The [variant of your graph](https://www.apollographql.com/docs/studio/schema/registry/#managing-environments-with-variants) to register the schema with.</p><p>The default value is `current`.</p> |
