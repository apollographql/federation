In a federated architecture, each of your graph's [subgraphs](https://www.apollographql.com/docs/federation/implementing-services/) uses the Rover CLI to register its schema with Apollo:
