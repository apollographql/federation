var url_polyfill = (function () {
	...
	const { percentDecodeBytes, utf8PercentEncodeString, isURLEncodedPercentEncode } = percentEncoding$1;
	...
	Object.defineProperty(url_polyfill, "__esModule", { value: true });

	const url = __importStar(whatwgUrl);
	var _default = url_polyfill.default = url;
