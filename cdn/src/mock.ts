...
const store: any = {
  'index.<hash>.html': 'index.html',
  '404.<hash>.html': '404.html',
  'cli/install.<hash>.sh': 'install cli',
}
...
export const mockManifest = () => {
  return JSON.stringify({
    ...
    'cli/install.sh': `cli/install.${HASH}.sh`,
  })
}
let cacheStore: any = {}
...
export function mockGlobal() {
  ...
  Object.assign(global, { SENTRY_PROJECT_ID: "123456", SENTRY_KEY: "0000aaaa1111bbbb2222cccc3333dddd" })
}