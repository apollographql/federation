...
- Print description text for the `schema` definition node, as allowed per the October 2021 edition of the GraphQL specification [PR #FIXME](https://github.com/apollographql/federation/pull/FIXME).
