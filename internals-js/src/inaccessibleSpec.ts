...
export class InaccessibleSpecDefinition extends FeatureDefinition {
  ...
  addElementsToSchema(schema: Schema) {
    this.addDirective(schema, 'inaccessible').addLocations(DirectiveLocation.FIELD_DEFINITION, DirectiveLocation.OBJECT, DirectiveLocation.INTERFACE, DirectiveLocation.UNION);
  }
