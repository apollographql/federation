 ...
 *
 * This function:
 * 1. Visits the `InlineFragmentNode` in a post-order traversal
 * 2. For each `InlineFragmentNode` (with no directives and a type condition):
 ...
 * 3. Returns the updated operation document and the generated `FragmentDefinitionNode`s
 */
