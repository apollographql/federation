...
- Relax `@interfaceObject` validation for Fed 1 subgraphs. ([#3392](https://github.com/apollographql/federation/pull/3392))
...
- Add validations for `@link` usages to prevent name conflicts. ([#3430](https://github.com/apollographql/federation/pull/3430))
