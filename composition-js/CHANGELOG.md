...
- Fixed access control verification of transitive requirements (through `@requires` and/or `@fromContext`) to ensure it works with chains of transitive dependencies. ([#3341](https://github.com/apollographql/federation/pull/3341))

- Allow interface object fields to specify access control ([#3341](https://github.com/apollographql/federation/pull/3341))
...
- Updated dependencies [[`20c75d1d60a48fc289d88c8d29652f1afc7553e4`](https://github.com/apollographql/federation/commit/20c75d1d60a48fc289d88c8d29652f1afc7553e4)]:
...
- Automatically propagate authorization requirements from implementing type to interface in the supergraph. ([#3326](https://github.com/apollographql/federation/pull/3326))
...
- Fix transitive auth requirements on `@requires` and `@fromcontext` ([#3326](https://github.com/apollographql/federation/pull/3326))
...
- Restrict usage of auth directives on interfaces ([#3326](https://github.com/apollographql/federation/pull/3326))
...
- Stricter merge rules for @requiresScopes and @policy ([#3326](https://github.com/apollographql/federation/pull/3326))
...
- Updated dependencies [[`2b88aec38d5bacb6ec815d885fdac47ef415124a`](https://github.com/apollographql/federation/commit/2b88aec38d5bacb6ec815d885fdac47ef415124a), [`18a9cfaf533602bb37fdf22962539ce0eae948c8`](https://github.com/apollographql/federation/commit/18a9cfaf533602bb37fdf22962539ce0eae948c8), [`9c0aaa0874c98ae8ce0cc38cad7f6f25d2c29635`](https://github.com/apollographql/federation/commit/9c0aaa0874c98ae8ce0cc38cad7f6f25d2c29635), [`f94e7b35c43ed64c67ff25c7aeb86ec0dd73370a`](https://github.com/apollographql/federation/commit/f94e7b35c43ed64c67ff25c7aeb86ec0dd73370a)]:
...
- Updated dependencies [[`97d81b79c3da10175bdf92c2209039efe352de79`](https://github.com/apollographql/federation/commit/97d81b79c3da10175bdf92c2209039efe352de79)]:
